      ...
      children: [
        Expanded(
          child: _buildActionTile(
            ...
            iconColor: theme.primaryAccent,
            iconBg: theme.primaryAccent.withValues(alpha: 0.12),
            title: ref.tr('about_suggest_game'),
            subtitle: 'Request catalog addition',
            theme: theme,
            onTap: () => _launchUrl(context, '$githubUrl/issues/new?template=game_request.md'),
          ),
        ),
        const SizedBox(width: 10),
        Expanded(
          child: _buildActionTile(
            ...
            theme: theme,
            onTap: () => _launchUrl(context, '$githubUrl/issues/new?template=bug_report.md'),
          ),
        ),
      ],
    );
