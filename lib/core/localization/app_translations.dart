...
class AppTranslations {
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'en': {
      ...
      'onboard_games_subtitle': "Select your games. We'll only recommend modes from what you actually play.",
      'search_games_hint': 'Search games...',
      'cat_competitive': 'COMPETITIVE & MATCH-BASED',
      'cat_competitive_sub': 'Penalty for leaving · Requires safe queue warnings',
      'cat_casual': 'CASUAL & FLEXIBLE',
      'cat_casual_sub': 'Pause or quit anytime · Safe for shorter gaps',
      'btn_customize_modes': 'Customize Modes',
      'select_min_game': 'Select at least 1 game',
      'onboard_modes_title': 'Activities & Modes',
      'onboard_modes_subtitle': "Enable the activities you actually play. Uncheck modes you don't play.",
      'btn_configure_protection': 'Configure Protection Level',
      'mode_flexible': 'Flexible',
      'onboard_protection_title': 'Prayer Protection',
      'onboard_protection_subtitle': 'Choose how conservative the queue warning system should be.',
      'onboard_theme_title': 'Choose Your Theme',
      'onboard_theme_subtitle': 'Select a visual aesthetic tailored for your gaming routine and prayer focus.',
    ...
    'ar': {
      ...
      'onboard_games_title': 'ما هي ألعابك المفضلة؟',
      'onboard_games_subtitle': 'اختر ألعابك المفضلة لنقترح عليك فقط الأطوار المناسبة لوقتك.',
      'search_games_hint': 'ابحث عن لعبة...',
      'cat_competitive': 'ألعاب تنافسية ومباريات',
      'cat_competitive_sub': 'عقوبة عند الخروج · تتطلب التأكد من كفاية الوقت قبل الصلاة',
      'cat_casual': 'ألعاب فردية ومرنة',
      'cat_casual_sub': 'يمكن إيقافها بأي وقت · مناسبة للأوقات القصيرة',
      'btn_customize_modes': 'تخصيص أطوار اللعب',
      'select_min_game': 'اختر لعبة واحدة على الأقل',
      'onboard_modes_title': 'أطوار اللعب والأنشطة',
      'onboard_modes_subtitle': 'فعّل الأطوار التي تلعبها فقط لتحديد مدة الجولات بدقة.',
      'btn_configure_protection': 'متابعة لمستوى الحماية',
      'mode_flexible': 'مرن',
      ...
      'onboard_theme_subtitle': 'اختر المظهر اللوني المفضل المناسب لشاشتك وجلسة لعبك.',
    ...
    'tr': {
      ...
      'onboard_games_title': 'Hangi oyunları oynuyorsunuz?',
      'onboard_games_subtitle': 'Oyunlarınızı seçin. Yalnızca oynadığınız modlar önerilecektir.',
      'search_games_hint': 'Oyun ara...',
      'cat_competitive': 'REKABETÇİ VE DERECELİ',
      'cat_competitive_sub': 'Ayrılma cezası · Güvenli sıra uyarısı gerektirir',
      'cat_casual': 'RAHAT VE ESNEK',
      'cat_casual_sub': 'İstediğiniz zaman çıkın · Kısa aralar için uygundur',
      'btn_customize_modes': 'Modları Özelleştir',
      'select_min_game': 'En az 1 oyun seçin',
      'onboard_modes_title': 'Aktiviteler ve Modlar',
      'onboard_modes_subtitle': 'Oynadığınız modları etkinleştirin.',
      'btn_configure_protection': 'Koruma Seviyesini Ayarla',
      'mode_flexible': 'Esnek',
      'onboard_protection_title': 'Namaz Koruması',
      'onboard_protection_subtitle': 'Sıra uyarı sisteminin güvenlik payını seçin.',
      'onboard_theme_title': 'Temanızı Seçin',
      'onboard_theme_subtitle': 'Oyun rutininize uygun bir görsel tema seçin.',
    ...
    'id': {
      ...
      'onboard_games_title': 'Apa game yang kamu mainkan?',
      'onboard_games_subtitle': 'Pilih game kamu. Kami hanya merekomendasikan mode dari game yang kamu mainkan.',
      'search_games_hint': 'Cari game...',
      'cat_competitive': 'KOMPETITIF & RANKED',
      'cat_competitive_sub': 'Penalti jika keluar · Perlu peringatan aman',
      'cat_casual': 'SANTAI & FLEKSIBEL',
      'cat_casual_sub': 'Bisa keluar kapan saja · Aman untuk waktu singkat',
      'btn_customize_modes': 'Sesuaikan Mode',
      'select_min_game': 'Pilih minimal 1 game',
      'onboard_modes_title': 'Aktivitas & Mode',
      'onboard_modes_subtitle': 'Aktifkan mode yang kamu mainkan.',
      'btn_configure_protection': 'Atur Tingkat Perlindungan',
      'mode_flexible': 'Fleksibel',
      'onboard_protection_title': 'Perlindungan Sholat',
      'onboard_protection_subtitle': 'Pilih tingkat keamanan peringatan antrean game.',
      'onboard_theme_title': 'Pilih Tema Anda',
      'onboard_theme_subtitle': 'Pilih tema visual yang cocok untuk rutinitasmu.',
    ...
    'ur': {
      ...
      'onboard_games_title': 'آپ کون سی گیمز کھیلتے ہیں؟',
      'onboard_games_subtitle': 'اپنی گیمز منتخب کریں تاکہ صرف متعلقہ موڈز تجویز کیے جائیں۔',
      'search_games_hint': 'گیم تلاش کریں...',
      'cat_competitive': 'مقابلہ جاتی گیمز',
      'cat_competitive_sub': 'چھوڑنے پر جرمانہ · وقت کی پیشگی تصدیق ضروری ہے',
      'cat_casual': 'عام اور آرام دہ گیمز',
      'cat_casual_sub': 'کسی بھی وقت بند کریں · مختصر وقفوں کے لیے محفوظ',
      'btn_customize_modes': 'موڈز کی ترتیب',
      'select_min_game': 'کم از کم 1 گیم منتخب کریں',
      'onboard_modes_title': 'سرگرمیاں اور موڈز',
      'onboard_modes_subtitle': 'صرف وہ موڈز آن رکھیں جو آپ کھیلتے ہیں۔',
      'btn_configure_protection': 'حفاظتی سطح منتخب کریں',
      'mode_flexible': 'لچکدار',
      'onboard_protection_title': 'نماز کی حفاظت',
      'onboard_protection_subtitle': 'وضو اور نماز کی تیاری کے لیے مناسب وقت منتخب کریں۔',
      'onboard_theme_title': 'تھیم منتخب کریں',
      'onboard_theme_subtitle': 'اپنی پسند کا رنگ اور تھیم منتخب کریں۔',
    ...
    'fr': {
      ...
      'onboard_games_title': 'À quoi jouez-vous ?',
      'onboard_games_subtitle': 'Sélectionnez vos jeux pour recevoir uniquement des modes adaptés.',
      'search_games_hint': 'Rechercher des jeux...',
      'cat_competitive': 'COMPÉTITIF ET MATCHS',
      'cat_competitive_sub': 'Pénalité en cas d\'abandon · Avertissement requis',
      'cat_casual': 'OCCASIONNEL ET FLEXIBLE',
      'cat_casual_sub': 'Quittez quand vous voulez · Adapté aux pauses courtes',
      'btn_customize_modes': 'Personnaliser les modes',
      'select_min_game': 'Sélectionnez au moins 1 jeu',
      'onboard_modes_title': 'Activités et modes',
      'onboard_modes_subtitle': 'Activez les modes que vous pratiquez réellement.',
      'btn_configure_protection': 'Configurer la protection',
      'mode_flexible': 'Flexible',
      'onboard_protection_title': 'Protection de la prière',
      'onboard_protection_subtitle': 'Définissez la marge de sécurité pour les ablutions.',
      'onboard_theme_title': 'Choisissez votre thème',
      'onboard_theme_subtitle': 'Sélectionnez un style visuel adapté à votre confort.',
    ...
    'de': {
      ...
      'onboard_games_title': 'Was spielst du?',
      'onboard_games_subtitle': 'Wähle deine Spiele aus.',
      'search_games_hint': 'Spiele suchen...',
      'cat_competitive': 'KOMPETITIV & GEWERTET',
      'cat_competitive_sub': 'Verlassen-Strafe · Sicherheitswarnung nötig',
      'cat_casual': 'CASUAL & FLEXIBEL',
      'cat_casual_sub': 'Jederzeit beenden · Sicher für kurze Pausen',
      'btn_customize_modes': 'Modi anpassen',
      'select_min_game': 'Mindestens 1 Spiel auswählen',
      'onboard_modes_title': 'Aktivitäten & Spielmodi',
      'onboard_modes_subtitle': 'Aktiviere die Modi, die du spielst.',
      'btn_configure_protection': 'Schutzstufe konfigurieren',
      'mode_flexible': 'Flexibel',
      'onboard_protection_title': 'Gebetsschutz',
      'onboard_protection_subtitle': 'Wähle den passenden Sicherheitspuffer für Wudu.',
      'onboard_theme_title': 'Design wählen',
      'onboard_theme_subtitle': 'Wähle ein Design für dein Spielerlebnis.',
    ...
    'ms': {
      ...
      'step_theme_title': 'Pilih Tema Visual',
      'onboard_games_title': 'Apa game yang anda main?',
      'onboard_games_subtitle': 'Pilih game anda untuk cadangan mod yang tepat.',
      'search_games_hint': 'Cari permainan...',
      'cat_competitive': 'KOMPETITIF & RANKED',
      'cat_competitive_sub': 'Penalti jika keluar · Perlu amaran keselamatan',
      'cat_casual': 'SANTAI & FLEKSIBEL',
      'cat_casual_sub': 'Boleh keluar bila-bila masa · Selamat untuk masa pendek',
      'btn_customize_modes': 'Ubah Suai Mod',
      'select_min_game': 'Pilih sekurang-kurangnya 1 game',
      'onboard_modes_title': 'Aktiviti & Mod',
      'onboard_modes_subtitle': 'Aktifkan mod yang anda kerap main.',
      'btn_configure_protection': 'Tetapkan Tahap Perlindungan',
      'mode_flexible': 'Fleksibel',
      'onboard_protection_title': 'Perlindungan Solat',
      'onboard_protection_subtitle': 'Tetapkan masa penampan wuduk dan solat.',
      'onboard_theme_title': 'Pilih Tema Visual',
      'onboard_theme_subtitle': 'Pilih tema yang sesuai dengan gaya permainan anda.',
    ...
    'ru': {
      ...
      'onboard_games_title': 'Во что вы играете?',
      'onboard_games_subtitle': 'Выберите ваши игры для рекомендаций.',
      'search_games_hint': 'Поиск игр...',
      'cat_competitive': 'СОРЕВНОВАТЕЛЬНЫЕ И РЕЙТИНГОВЫЕ',
      'cat_competitive_sub': 'Штраф за выход · Требуется проверка времени',
      'cat_casual': 'ОДИНОЧНЫЕ И СВОБОДНЫЕ',
      'cat_casual_sub': 'Выход в любой момент · Безопасно для коротких пауз',
      'btn_customize_modes': 'Настроить режимы',
      'select_min_game': 'Выберите минимум 1 игру',
      'onboard_modes_title': 'Режимы и активности',
      'onboard_modes_subtitle': 'Включите режимы, в которые вы играете.',
      'btn_configure_protection': 'Настроить защиту',
      'mode_flexible': 'Гибкий',
      'onboard_protection_title': 'Защита намаза',
      'onboard_protection_subtitle': 'Выберите запас времени для омовения.',
      'onboard_theme_title': 'Выберите тему',
      'onboard_theme_subtitle': 'Выберите визуальный стиль интерфейса.',
    ...
    'es': {
      ...
      'onboard_games_title': '¿A qué juegas?',
      'onboard_games_subtitle': 'Selecciona tus juegos para calcular la duración de las partidas.',
      'search_games_hint': 'Buscar juegos...',
      'cat_competitive': 'COMPETITIVO Y EMPAREJAMIENTO',
      'cat_competitive_sub': 'Penalización por abandono · Requiere verificar tiempo',
      'cat_casual': 'CASUAL Y FLEXIBLE',
      'cat_casual_sub': 'Pausa o sal cuando quieras · Seguro para huecos cortos',
      'btn_customize_modes': 'Personalizar modos',
      'select_min_game': 'Selecciona al menos 1 juego',
      'onboard_modes_title': 'Actividades y Modos',
      'onboard_modes_subtitle': 'Activa los modos que juegas habitualmente.',
      'btn_configure_protection': 'Configurar protección',
      'mode_flexible': 'Flexible',
      'onboard_protection_title': 'Protección de la oración',
      'onboard_protection_subtitle': 'Elige el margen de seguridad para la ablución.',
      'onboard_theme_title': 'Elige tu tema',
      'onboard_theme_subtitle': 'Selecciona un estilo visual para tu rutina.',
